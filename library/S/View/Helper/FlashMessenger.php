...
class S_View_Helper_FlashMessenger extends Zend_View_Helper_Abstract
{
     ...
     */
    public function flashMessenger ($key = 'notice', $template = '<p class="msg %s">%s <a class="close" href="#">x</a></p>')
    {
        ...
        foreach ($messages as $message) {
            ...
            $output .= sprintf($template, $key, $translate->translate($message));
        }
        return $output;
    }
