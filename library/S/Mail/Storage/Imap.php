<?php
/**
 * S Library Mail Storage
 *
 * @category   S
 * @package    S_Mail
 * @copyright  Copyright (c) 2010 Step-Soft Ltd (http://www.stepsoft.bg)
 */
...
class S_Mail_Storage_Imap extends Zend_Mail_Storage_Imap
{
        ...
        foreach ($folders as $globalName => $data) {
            do {
                if (!$parent || strpos($globalName, $parent) === 0) {
                    ...
                    $folder = new Zend_Mail_Storage_Folder(S_Decode::UTF7($localName), S_Decode::UTF7($globalName), $selectable);
    ...
    {
        parent::selectFolder(S_Encode::UTF7((string)$globalName));
    }
